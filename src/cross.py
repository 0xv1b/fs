...
plt.figure(1)
plt.xlabel(r'x-axis ($\mu$m)',fontsize=14)
plt.ylabel(r'y-axis ($\mu$m)',fontsize=14)
#for ax in axes:
...
pcbar.set_label(label=r'$I_{ph}$', fontsize=14)
ax = plt.gca()
...
# plt.tight_layout()
# plt.savefig("./images/Reflectance_Map_Xscan.pdf")
# plt.show()
...
# PUMP RIGHT
plt.plot(1.17213, 13.36213,  marker='x', markersize=16,markeredgewidth=4, color='red')


# PUMP MIDDLE 1.155 13.35976
plt.plot(1.155, 13.35976,  marker='x', markersize=16,markeredgewidth=4, color='blue')



plt.tight_layout()
#plt.savefig("./images/Reflectance_Map_Xscan.pdf")
#plt.savefig("./images/Reflectance_Map_Xscan180.pdf")
plt.savefig("./images/Reflectance_Map_Pump.pdf")
plt.show()
